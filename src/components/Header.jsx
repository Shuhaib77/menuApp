...
function Header() {
  ...
  return (
    <>
      <div className="">
        <div className="flex h-[50px] justify-around ">
          ...
          <div className="flex w-full justify-around items-center h-[20px] mt-7  ">
            ...
            <h1 className="text-blue-500 md:block hidden">MENU</h1>
            <h1 className="md:block hidden">MAKE A RESERVATION</h1>
            <h1 className="md:block hidden">CONTACT US</h1>
          </div>
      ...
      {
        menu &&
        <div className="h-[100px] w-full backdrop-blur-2xl inset-0 fixed  bg-amber-50">
            <div> </div>
